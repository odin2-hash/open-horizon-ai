...
import { BookOpen, HardDrive, Settings, Lightbulb, FileText, Users } from 'lucide-react';
...
export const SideNavigation: React.FC<SideNavigationProps> = ({
  ...
  // Open Horizon AI navigation items for Erasmus+ project management
  ...
  const logoAlt = 'Open Horizon AI Logo';
